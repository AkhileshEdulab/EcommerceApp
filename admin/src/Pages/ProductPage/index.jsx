...
import Progress from '../../Components/Dashboard/Products/Progress';
    ...
    <div className="main bg-white border rounded-md p-4 flex flex-col gap-4">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button variant="contained" onClick={()=>setProductDrawer({
            open:true,
            model:'AddProduct',
          })}>
                ...
                <td className="p-2">
                 <div className="flex items-center justify-center gap-4">
                   ...
                   <div className="flex flex-col text-sm items-start">
                     <p className="font-medium">Electronic Rubber Table</p>
                     <span className="text-gray-500">Jugs</span>
                   </div>
                 </div>
               </td>
